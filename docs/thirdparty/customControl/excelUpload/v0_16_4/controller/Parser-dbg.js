...
sap.ui.define(["../types", "./Util"], function (___types, __Util) {
  ...
  class Parser {
    static parseExcelData(sheetData, typeLabelList, component, errorHandler, util) {
      const payloadArray = [];
    ...
    static checkDate(value, metadataColumn, util, errorHandler, index) {
    ...
    static addParsingError(text, util, errorHandler, index, array) {
